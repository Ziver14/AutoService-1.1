...
namespace AutoService
{
    internal class DBWork
    {
        ...
        static public void DeleteMechanic(string mechanicName)
        {
            string init_del = "DELETE FROM Mechanics WHERE name = @Name";
            ...
            using (SQLiteConnection conn = new SQLiteConnection(path))
            {
                ...
                {
                    cmd.CommandText = init_del;
                    cmd.Parameters.AddWithValue("@Name", mechanicName);
        ...
        static public void UpdateMechanicName(string oldName, string newName)
        {
            string init_updateName = "UPDATE Mechanics SET Name = @NewName WHERE Name = @OldName;";
            using (SQLiteConnection conn = new SQLiteConnection(path))
            {
                using (SQLiteCommand cmd = conn.CreateCommand())
                {
                    cmd.CommandText = init_updateName;
